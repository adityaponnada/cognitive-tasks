 ...
 */
public class StressOneInstructions extends javax.swing.JFrame {

    /**
     * Creates new form StressOneInstructions
     */
    public StressOneInstructions() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("You will have to keep in mind the answer from each operation and use it in subsequent steps until you see a text box asking you for your final answer. ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StressOneInstructions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StressOneInstructions().setVisible(true);
            }
        });
    }   
